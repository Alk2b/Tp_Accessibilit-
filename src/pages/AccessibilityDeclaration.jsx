  ...
  return (
    <div className="min-h-screen bg-white font-inter pt-20">
      <main className="container mx-auto max-w-2xl px-4 py-8">
        <h1 className="text-3xl font-newsreader mb-6">Déclaration d&apos;accessibilité</h1>
        <section className="space-y-4">
          ...
          <h2 className="text-2xl font-newsreader mb-4">Mesures prises pour assurer l&apos;accessibilité</h2>
          ...
          <h2 className="text-2xl font-newsreader mb-4">Retour d&apos;information et contact</h2>
          <p>
            Si vous rencontrez des difficultés d&apos;accessibilité sur notre site, veuillez nous contacter à l&apos;adresse suivante :
            <a href="mailto:accessibilite@alinia.com" className="text-blue-600 hover:underline">accessibilite@alinia.com</a>.
